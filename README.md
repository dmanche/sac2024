...
## Requisitos 
- Modelo SMPL. Es necesario disponer de la libreria [SMPL](smpl.is.tue.mpg.de/index.html), la cual contiene código necesario, así como los modelos SMPL utilizados.

        ...
        **kwargs
        ...
        if data_struct is None:
            if osp.isdir(model_path):
                ...
                model_fn = '{}.{ext}'.format(gender.lower(), ext='pkl') #TODO: modificamos el path para que no de error cuando se lea. En este caso, lo modifico para que coincida con los nombres que tienen mis modelos smpl (male.pkl, female.pkl)
...
class SMPLH(SMPL):
    ...
    def __init__(
        ...
        ext: str = 'npz', #TODO: añadimos la extensión
        **kwargs
    ) -> None:
        ...
        if data_struct is None:
            # Load the model
            if osp.isdir(model_path):
                model_fn = '{}_smplh.{ext}'.format(gender.lower(), ext=ext) # TODO: Modificamos para que coindica con el path, de la misma forma que hemos hecho con los modelos SMPL anteriormente.
            ...
            print('atributos despues del struct',dir(data_struct))
...
class SMPLX(SMPLH):
	...
	kid_template_path: str = '',
        ...
        age: str = 'adult',
        dtype=torch.float32,
        ext: str = 'pkl', # TODO: Es necesario que fijemos el formato utilizado (.npz o .pkl)
        **kwargs
    ) -> None:
        ...
        if osp.isdir(model_path):
            ...
            model_fn = '{}.{ext}'.format(gender.lower(), ext=ext) #TODO: cambiamos esta linea para que coincida con el nombre del modelo, igual que se ha hecho antes
...
def create(
    ...
    **kwargs
    ...
    if model_type.lower() == 'smpl':
        ...
        return SMPLH(model_path, **kwargs) #TODO: Puede dar problemas al no reconocer las manos en los datos de AMASS
    elif model_type.lower() == 'smplx':
